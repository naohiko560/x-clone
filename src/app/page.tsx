              ...
              <div key={i} className="border-t-[0.5px] border-gray-600 p-2 pr-4 flex space-x-4">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="text-white text-base">
                    ...
                    Dolorem, incidunt exercitationem molestias veniam temporibus blanditiis omnis
                    accusantium voluptatum, voluptas eos autem laudantium quam necessitatibus
                    excepturi impedit. Sed, earum. Quod dignissimos ratione molestias dolore, atque
                    itaque distinctio quidem eius, veniam sed tenetur sint similique quaerat aliquam
                    cumque repellat hic?
                  </div>
